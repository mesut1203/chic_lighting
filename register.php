                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <?php 
                        if(isset($_SESSION['email'])){
                            ...
                            echo "<a href='profile.php'><i class='fas fa-solid fa-user'></i></a>";
                            echo "Hello " . htmlspecialchars($_SESSION['name']) . "<button class='btn btn-link' type='submit' name='logout'>Log out</button>";
                            echo "</li>";
                            echo "</form>";
                        }
                        else {
    ...
    <section class="my-5 py-5">
        ...
        <div class="mx-auto container">
            <form id="register-form" method="post" action="register_process.php">
                ...
                <div class="form-group">
                    <a href="login.php" id="login-url" class="btn btn-link">
